...
export function wasm_eff_result(vin: number, vout: number, fsw: number, ind: number, rl: number, rfb1: number, rfb2: number, ron: number, rd: number, tr: number, tf: number, tdd1: number, tdd2: number, qg1: number, qg2: number): WasmEffCalResult;
export function chart2(xs: Float64Array, ys: Float64Array, iout: number): void;
export class Chart {
  private constructor();
  free(): void;
  static coil_current(canvas: HTMLCanvasElement, dil_on: number, dil_off: number, intercept_on: number, intercept_off: number, ontime_cha: number, period: number, _time: number, unit_prefix: string): void;
}
export class Point {
  private constructor();
  free(): void;
...
export interface InitOutput {
  ...
  readonly __wbg_wasmeffcalresult_free: (a: number, b: number) => void;
  readonly wasmeffcalresult_new: (a: number, b: number, c: number, d: number) => number;
  readonly wasmeffcalresult_get_xs: (a: number) => [number, number];
  readonly wasmeffcalresult_get_ys: (a: number) => [number, number];
  readonly wasm_eff_result: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => number;
  ...
  readonly chart2: (a: number, b: number, c: number, d: number, e: number) => void;
